...
import ProjectDetailsSecond from '/assets/project/project-details-2.jpg'
...
export default function projectDetails() {
	return (
		<Grid>
			...
			<Typography
				sx={{ fontWeight: 'bold', pt: 4, fontSize: '24px', mb: '20px' }}
			>
			...
			<Typography sx={{ fontWeight: 'bold', fontSize: '24px', mb: '20px' }}>
